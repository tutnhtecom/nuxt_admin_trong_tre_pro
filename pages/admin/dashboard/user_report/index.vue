    ...
    <div class="content-mp">
        ...
        <b-row>
            <b-col cols="12" sm="7">
                ...
                <div>
                    <div class="mb-4">
                        <title-header>Tổng quan tình trạng hoạt động của User</title-header>
                    </div>
                    <user-report></user-report>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-5">
                    <title-header>Báo cáo lượng User</title-header>
                ...
                <div class="mt-8">
                    <table class="table table-bordered table-hover table-striped">
                        <thead class="bg-primary">
                            <th>
                                <tr>
                                    <span class="text-light">Loại User</span>
                                </tr>
                            </th>
                            <th>
                                <tr>
                                    <span class="text-light">Ngày tạo</span>
                                </tr>
                            </th>
                            <th>
                                <tr>
                            ...
                            <th>
                                <tr>
                                    <span class="text-light">Trình độ</span>
                                </tr>
                            </th>
                        </thead>
                        <tbody>
...
export default {
    ...
    methods: {
        async load_data() {
            await api.get(`bao-cao/danh-sach-user?dien_thoai=&dia_chi=&dich_vu_id=&denNgay=&tuNgay=&page=${this.current_page}&limit=10&sort=1`, {
        ...
        async export_excel() {
            ...
            await api.get(`bao-cao/export-excel-danh-sach-user?dien_thoai=&dia_chi=&dich_vu_id=&denNgay=&tuNgay=&page=1&limit=&sort=`, {
                'Content-Type': 'multipart/form-data',
                Authorization: 'Bearer ' + this.token
            }).then(res => {
                Swal.close()
